...
用户同意，其提供的真实、准确、合法的网易邮箱帐号注册资料是作为认定用户与其网易邮箱帐号的关联性以及用户身份的唯一证据。用户在享用网易各项服务的同时，同意接受网易提供的各类信息服务。网易公司提醒用户，用户注册网易邮箱帐号或更新注册信息时填写的证件号码，在注册网易邮箱帐号成功或补充填写后将无法进行修改，请用户慎重填写各类注册信息。
...
尊重用户隐私是网易公司的一项基本政策。网易公司将按照网易网站上公布的隐私政策（http://corp.163.com/gb/legal.html ）收集、存储、使用、披露和保护您的个人信息。请您完整阅读上述隐私权政策，以帮助您更好地保护您的个人信息。
