<template lang="html">
  <div class="saler">
    ...
    <div class="main">
      <div class="my-orders">
        <Table :row-class-name="rowClassName" :columns="columns" :data="orderData"</Table>
      </div>
  ...
  .saler
    ...
    .header
      ...
      .header-icon
        ...
        border-radius: 50%
        span
          i-font-size(font-size, 54)
          &::before
            color: #ffffff
      >span
        margin-left: 3.2vw
        i-font-size(font-size, 30)
        color: #ffffff
        letter-spacing: .2vw
    .main
      width: 100%
