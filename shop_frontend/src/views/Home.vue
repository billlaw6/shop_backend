...
<script>
  ...
  // import tagsPageOpened from '@/views/components/main/tags-page-opened.vue'
  // import breadcrumbNav from '@/views/components/main/breadcrumb-nav.vue'
  ...
  // import messageTip from '@/views/components/main/message-tip.vue'
  // import themeSwitch from '@/views/components/main/theme-switch/theme-switch.vue'
